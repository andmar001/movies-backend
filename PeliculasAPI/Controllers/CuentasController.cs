...
namespace PeliculasAPI.Controllers
{
    ...
    public class CuentasController : ControllerBase
    {
        ...
        //Endpoint para hacer admin a un usuario
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Policy = "EsAdmin")]
        [HttpPost("HacerAdmin")]
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Login([FromBody] CredencialesUsuario credenciales)
        {
            ...
            {
                return BadRequest("Login incorrecto"); //no es correcto dar informacion del sistema - mensaje muy vago 
            }
        }
        ...
        private async Task<RespuestaAutenticacion> ConstruirToken(CredencialesUsuario credenciales)
        {
            ...
            //obtener los claims del usuario - obtener los claims del usuario
            var claimsDB = await userManager.GetClaimsAsync(usuario);
            //agregar los claims del usuario a la lista de claims
